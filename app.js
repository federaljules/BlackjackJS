...
function teeKortti(maa, num, kuva, pj, tausta) { 
    ...
    if(maa =="Hertta"){
        ...
        kortti_kuva.setAttribute("src", "hertta.png");
        ...
        kortti_kuva.setAttribute("src", "risti.png");
        kortti1_luku.innerHTML = num;
        kortti_JQK.innerHTML = kuva;
        ...
        kortti_kuva.setAttribute("src", "pata.png");
        kortti1_luku.innerHTML = num;
        kortti_JQK.innerHTML = kuva;
    }
    else if(maa == "Ruutu"){

        kortti_kuva.setAttribute("src", "timantti.png");
        kortti1_luku.innerHTML = num;
        kortti_JQK.innerHTML = kuva;
    }
